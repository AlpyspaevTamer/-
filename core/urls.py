...
from .views import AdminUserListView, assign_user_group
...
urlpatterns = [
    ...
    path('staff/users/', AdminUserListView.as_view(), name='admin_user_list'),
    path('staff/assign-group/<int:user_id>/', assign_user_group, name='assign_user_group'),
    path('staff/groups/', manage_groups_page, name='manage_groups'),
    path('staff/groups/delete/<int:group_id>/', delete_group, name='delete_group'),
    path('test/<int:pk>/results/', view_test_results, name='test_results_admin'),
    path('staff/users/delete/<int:pk>/', delete_user, name='delete_user'),
